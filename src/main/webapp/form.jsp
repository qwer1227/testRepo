...
<<<<<<< HEAD
            <input class="form-control" type="text" name="name" placeholder="이름을 작성해주세요 예)홍길동">
        </div>
        <div class="mb-3">
            <label class="form-label">아이디*</label>
            <input class="form-control" type="text" name="id" placeholder="아이디를 입력해주세요 예)abc1234">
        </div>
        <div class="mb-3">
            <label class="form-label">비밀번호*</label>
            <input class="form-control" type="password" name="pwd" placeholder="대,소문자 및 특수문자 8~16자 이내">
        </div>
        <div class="mb-3">
            <label class="form-label">비밀번호 확인*</label>
            <input class="form-control" type="password" name="pwdvali" placeholder="한 번 더 입력해주세요">
        </div>
        <div class="mb-3">
            <label class="form-label">이메일*</label>
            <input class="form-control" type="email" name="email" placeholder="이메일을 입력해주세요 예)abc@gmail.com">
=======
...
<br>제2조(정의)
<br>①&nbsp;“몰”이란&nbsp;<span style="color: rgb(0, 0, 0); font-size: 12px; font-style: normal; font-variant-ligatures: normal; font-variant-caps: normal; font-weight: 400; letter-spacing: normal; orphans: 2; text-align: start; text-indent: 0px; text-transform: none; widows: 2; word-spacing: 0px; -webkit-text-stroke-width: 0px; white-space: normal; text-decoration-thickness: initial; text-decoration-style: initial; text-decoration-color: initial; float: none; display: inline !important;">(주)비저너리</span>
&nbsp;회사가 재화 또는 용역(이하&nbsp;“재화 등”이라 함)을 이용자에게 제공하기 위하여 컴퓨터 등 정보통신설비를 이용하여 재화 등을 거래할 수 있도록 설정한 가상의 영업장을 말하며,&nbsp;아울러 사이버몰을 운영하는 사업자의 의미로도 사용합니다.
